...
const theme = merge(tailwind, {
  ...
  fonts: {
    body: 'Menlo, Monaco, Consolas, "Liberation Mono", "Courier New", monospace', //`-apple-system, BlinkMacSystemFont,"Segoe UI",Roboto,"Helvetica Neue",Arial,"Noto Sans",sans-serif,"Apple Color Emoji","Segoe UI Emoji","Segoe UI Symbol","Noto Color Emoji"`,
  },
  styles: {
    root: {
      color: `text`,
